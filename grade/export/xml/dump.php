...
$showgroups         = optional_param('export_showgroups', 0, PARAM_BOOL);
$showcohorts        = optional_param('export_showcohorts', 0, PARAM_BOOL);
...
$formdata = grade_export::export_bulk_export_data($id, $itemids, $exportfeedback, $onlyactive, $displaytype,
        $decimalpoints, $updatedgradesonly, null, $showgroups, $showcohorts);
