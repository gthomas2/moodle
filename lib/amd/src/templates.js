...
define([ 'core/mustache',
    ...
    /** @var {string{}} templateRequests - Template requests in progress */
    ...
    Renderer.prototype.getTemplate = function(templateName, async) {
        ...
        // Is this template already in an active request?
        if (searchKey in templateRequests) {
            // Return promise for existing request.
            return templateRequests[searchKey];
        }
        ...
        // Add this template's promise to existing requests.
        templateRequests[searchKey] = promise;

        // When template is either successfully loaded or fails we need to remove this template from the request
        // tracker.
        promise.always(
            function() {
                // Remove template from templateRequests tracker.
                delete templateRequests[searchKey];
            }
        );
