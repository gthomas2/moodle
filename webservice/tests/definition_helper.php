 ...
 */
class core_definition_helper_test extends advanced_testcase {
...
EOF;
        ...
        $testclass = new var_nodescription();
        $definitionhelper = new definition_helper_testable($testclass);
...
EOF;
    ...
    public function test_cache_definition() {
        ...
        $cache = cache::make('core', 'webservicedefinitions');
